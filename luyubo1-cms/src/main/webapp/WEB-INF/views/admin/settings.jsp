...
<form>
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" name="site_domain" value="${settings.site_domain }" class="form-control" placeholder="http://www.1709d.com">
		</div>
	</div>
	<div class="form-group row">
		<label for="inputEmail3" class="col-sm-2 col-form-label">网站名称</label>
		<div class="col-sm-10">
			<input type="text" name="site_name" value="${settings.site_name }" class="form-control" placeholder="今日头条">
		</div>
	</div>
	<div class="form-group row">
		<div class="col-sm-10">
